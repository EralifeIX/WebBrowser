...
constexpr auto qt_meta_stringdata_CLASSHistoryViewENDCLASS = QtMocHelpers::stringData(
    "HistoryView",
    "historyItemDeleted",
    "",
    "goToUrl",
...
void HistoryView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->historyItemDeleted((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->goToUrl((*reinterpret_cast< std::add_pointer_t<QUrl>>(_a[1]))); break;
        case 2: _t->slotOnDelete(); break;
        case 3: _t->slotOnItemClicked((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HistoryView::*)(int );
            if (_t _q_method = &HistoryView::historyItemDeleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HistoryView::*)(QUrl );
            if (_t _q_method = &HistoryView::goToUrl; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void HistoryView::historyItemDeleted(int _t1)
{
...
// SIGNAL 1
void HistoryView::goToUrl(QUrl _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
